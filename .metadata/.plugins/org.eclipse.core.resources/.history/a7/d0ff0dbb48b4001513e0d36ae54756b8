...
public class ChessBoard {
	...
	/*  <<<This is including scanner loop>>>
	 * ChessBoard chess = new ChessBoard();
System.out.println("Welcome to Chess! This is a two-person\nhand-off game with movement rules\nenforced. Type 'help' for more info.");
@SuppressWarnings("resource")
Scanner inputScan = new Scanner(System.in);
chess.resetBoard();
System.out.println(" ---Game start!--- \n");
chess.printBoardState_hr();
